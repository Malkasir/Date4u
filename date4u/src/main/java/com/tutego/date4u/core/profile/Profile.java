...
public class Profile {
    ...
    // Constants representing genders of a unicorn.
    ...
    public Profile(Long id, String nickname, LocalDate birthdate, int hornlength, int gender, Integer integer, String description, LocalDateTime lastseen) {
    }
